        ...
        <div className="flex flex-wrap gap-4 items-center justify-between">
          ...
          <div className="relative flex-grow max-w-sm">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border text-gray-700 border-gray-300 rounded-md focus:ring-[#29AAE1] focus:border-[#29AAE1] text-sm"
            />
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <button
              ...
              className="px-4 py-2 border text-gray-700 border-gray-300 rounded-md text-sm flex items-center gap-1 hover:bg-gray-50"
            >
              More Filters
            ...
            <button
              onClick={onExportPdf}
              className="px-4 py-2 border text-gray-700 border-gray-300 rounded-md text-sm hover:bg-gray-50"
            >
              Export PDF
            </button>
            <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 border text-gray-700 border-gray-300 rounded-md text-sm"
                />
              </div>
              <div>
                ...
                <select 
                  id="features-select"
                  className="w-full p-2 border text-gray-700 border-gray-300 rounded-md text-sm appearance-none"
                >
